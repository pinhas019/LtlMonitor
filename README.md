...
| [docs/g1_trav_run.md](docs/g1_trav_run.md) | the runbook for an experiment day on the real G1 beside TRAV — build order, preflight, what to record, and the traps someone already fell into |
